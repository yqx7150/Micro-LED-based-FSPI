...
class GetCT(Dataset):
    ...
    def __getitem__(self,index):
        ...
        #图像
        y = cv2.imread(self.data_names[index], cv2.IMREAD_GRAYSCALE)
        y = cv2.resize(y, (256, 256))
        y = y.astype(np.float32) / np.max(y)
        y = np.expand_dims(y,0)
        # 频谱
        # y = scio.loadmat("../y_mat/y_"+str(index)+".mat")["f"]
        # y = y.transpose(2,0,1)
        return y
...
def get_dataset(config, uniform_dequantization=False, evaluation=False):
  ...
  # dataset = GetCT(root= "/home/a604/code/xzz/data/afhq/train/cat")
  # test_dataset = GetCT(root= "/home/a604/code/xzz/data/afhq/val/one_cat")
  # dataset = GetCT(root= "/home/a604/code/xzz/data/coin/train_dataset_paper/y_filter_augmented_images")
  # test_dataset = GetCT(root= "/home/a604/code/xzz/data/coin/train_dataset_paper/y_val")
  # dataset = GetCT(root= "/home/a604/code/xzz/data/afhq/train/dog")
  # test_dataset = GetCT(root= "/home/a604/code/xzz/data/afhq/val/dog")
  dataset = GetCT(root= "/home/a604/code/xzz/data/256ball/train")
  test_dataset = GetCT(root= "/home/a604/code/xzz/data/256ball/val")
